...
export const mockSubscriptionTiers = [
  {
    id: "tier-free",
    name: "Free",
    description: "Start streaming with basic features",
    price: 0,
    currency: "NGN",
    features: ["1 concurrent stream", "Basic audio quality", "Standard analytics", "Community support"],
  ...
  },
  {
    id: "tier-basic",
    name: "Basic",
    description: "Perfect for hobby DJs building an audience",
    price: 5000,
    currency: "NGN",
    features: ["3 concurrent streams", "High audio quality (320kbps)", "Enhanced analytics", "Email support", "Custom branding", "Stream scheduling"],
  ...
  },
  {
    id: "tier-pro",
    name: "Pro",
    description: "Professional tools for serious DJs",
    price: 15000,
    currency: "NGN",
    features: ["5 concurrent streams", "Studio audio quality (lossless)", "Advanced AI analytics", "Priority support", "Stream recording", "NFT marketplace access", "Tip alerts & animations"],
  ...
  },
  {
    id: "tier-premium",
    name: "Premium",
    description: "Everything for top-tier DJs and labels",
    price: 50000,
    currency: "NGN",
    features: ["Unlimited streams", "Master audio quality", "Real-time AI mixing", "Dedicated account manager", "White-label options", "API access", "Merchandise store", "Revenue sharing"],
